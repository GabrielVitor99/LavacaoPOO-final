...
public class VeiculoDAO{
   ...
   public List<Veiculo> listar() {
    String sql = "SELECT v.id AS veiculo_id, v.placa AS veiculo_placa, v.observacoes AS veiculo_observacoes, v.id_cor AS cor_id, v.id_modelo AS modelo_id, " +
                 "c.id as cor_id, c.nome AS cor_nome, m.descricao as modelo_descricao, " +
                 "ma.id as id_marca, ma.nome as marca_nome, cl.id as cliente_id " +
                 "FROM veiculo v " +
    ...
    public List<Veiculo> listarPorModelo(Modelo modelo) {
        String sql =  "SELECT v.id as veiculo_id, v.placa as veiculo_placa, v.observacoes as veiculo_observacoes,  "
                ...
                + "ma.id as id_marca, ma.nome as marca_nome "
                + "FROM veiculo v "
    ...
    public Veiculo buscar(Veiculo veiculo) {
     ...
     private Veiculo populateVO(ResultSet rs) throws SQLException {
      ...
      /*instanciamento, acessa os metodos getters and setters*/   
      ...
      veiculo.getModelo().getMarca().setId(rs.getInt("id_marca"));
